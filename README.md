...
- 🌐 **Full‑stack web** — Django / FastAPI / **Rails + Turbo** with React / Next.js.  
...
> 💡 Check out my **pinned repositories** below for public code, infra experiments, and smaller agentic / trading prototypes. 👇
